...
[Documentation](../../docs/index.md) · [Runnable example](examples/access-policy.rs) · [Source](src/lib.rs)
...
![Three decisions from the access-policy example](../../docs/assets/access-decisions.svg)
...
The [guide](../../docs/getting-started.md) also runs this example in a separate
